...
PROFILES: dict[ModuleId, ModuleProfile] = {
    ModuleId.SALES: ModuleProfile(
        ...
        charts=(ChartKind.LINE, ChartKind.AREA, ChartKind.BAR, ChartKind.DONUT, ChartKind.TABLE),
    ...
    ModuleId.PERFORMANCE: ModuleProfile(
        ...
        charts=(ChartKind.BAR, ChartKind.HEATMAP, ChartKind.SCATTER, ChartKind.TABLE),
    ...
    ModuleId.CAMPAIGNS: ModuleProfile(
        ...
        charts=(ChartKind.LINE, ChartKind.BAR, ChartKind.DONUT, ChartKind.HEATMAP, ChartKind.TABLE),
    ...
    ModuleId.WORKFORCE: ModuleProfile(
        ...
        charts=(ChartKind.LINE, ChartKind.BAR, ChartKind.HEATMAP, ChartKind.TABLE),
    ...
    ModuleId.COMPENSATION: ModuleProfile(
        ...
        charts=(ChartKind.LINE, ChartKind.BAR, ChartKind.DONUT, ChartKind.SCATTER, ChartKind.TABLE),
