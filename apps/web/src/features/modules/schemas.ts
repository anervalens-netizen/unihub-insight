...
export const moduleIds = ['sales', 'performance', 'campaigns', 'workforce', 'compensation', 'finance', 'planning'] as const;
export type ModuleId = (typeof moduleIds)[number];
export const chartKinds = ['line', 'area', 'bar', 'stacked-bar', 'donut', 'heatmap', 'scatter', 'waterfall', 'table', 'kpi'] as const;
...
export const moduleAnalyticsSchema = z.object({
  ...
  distribution: z.array(z.object({ id: z.string(), label: z.string(), value: numeric, share_pct: numeric })),
  ...
  matrix: z.array(z.object({ x: z.string(), y: z.string(), value: numeric, label: z.string().nullable().optional(), risk })),
  alerts: z.array(z.object({ id: z.string(), severity: z.enum(['info', 'warning', 'critical']), title: z.string(), description: z.string(), entity_label: z.string().nullable().optional() })),
});
