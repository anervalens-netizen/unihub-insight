...
export const moduleMetrics: Record<
  DashboardWidget['module'],
  Array<{ id: string; label: string }>
> = {
  sales: [
    { id: 'sales.total', label: 'Vânzări' },
    { id: 'target.progress_pct', label: 'Realizare target' },
    { id: 'receipts.average_value', label: 'Valoare medie bon' },
    { id: 'receipt_2plus_pct', label: 'Bonuri 2+' },
  ],
  performance: [
    { id: 'performance.average', label: 'Realizare medie' },
    { id: 'performance.at_target', label: 'Entități la target' },
    { id: 'performance.volatility', label: 'Volatilitate' },
    { id: 'performance.daily_productivity', label: 'Productivitate' },
  ],
  campaigns: [
    { id: 'campaigns.focus_sales', label: 'Vânzări Focus' },
  ...
  workforce: [
    ...
    { id: 'workforce.productivity', label: 'Productivitate' },
    { id: 'workforce.coverage', label: 'Acoperire' },
    { id: 'workforce.stability', label: 'Stabilitate' },
  ],
  compensation: [
    { id: 'compensation.payroll', label: 'Cost salarial' },
    { id: 'compensation.average', label: 'Salariu mediu' },
    { id: 'compensation.median', label: 'Salariu median' },
    { id: 'compensation.sales_ratio', label: 'Cost / vânzări' },
  ],
  finance: [
    { id: 'finance.revenue', label: 'Venit net' },
    { id: 'finance.ebit', label: 'EBIT' },
    { id: 'finance.ebit_margin', label: 'Marjă EBIT' },
    { id: 'finance.operating_costs', label: 'Cost operațional' },
  ],
  planning: [
    { id: 'planning.forecast', label: 'Forecast' },
    { id: 'planning.target_gap', label: 'Gap target' },
