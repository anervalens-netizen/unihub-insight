      ...
      <div className="widget-editor-main">
        ...
        <select
          ...
          onChange={(event) => {
            ...
            onChange({
              module,
              metric_id: metric?.id ?? widget.metric_id,
              title: metric?.label ?? widget.title,
              visualization,
              filters,
            });
          }}
        ...
        >
          {moduleMetrics[widget.module].map((metric) => (
        ...
        >
          {moduleVisualizations[widget.module].map((visualization) => (
