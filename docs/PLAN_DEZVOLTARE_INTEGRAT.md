...
**POC-uri și stare:** browser QA reproductibil 50/50 acoperă cele 10 rute, formele native, toggle-ul histogramă↔boxplot, 1180/1440/1920/ultrawide, light/dark, Compact/Comfortable, inspector, URL drill/reload/reset, selecție temporală, deep-link Retail și 403; trendurile lungi activează zoom, iar bundle-ul are buget verificat. POC-ul Canvas din 2026-08-06 trece pe 10 widgeturi, heatmap 100×36, scatter 5.000 puncte, first render 7.130,2 ms, resize blocking p95 158,0 ms și heap post-GC +16.853.453 bytes după trei remount-uri, sub pragul de 64 MiB. SVG rămâne neautorizat fără un caz de business distinct. PNG rămâne non-persistent și cu pixel ratio controlat. Poarta rămâne interacțiune p95 sub 200 ms.
