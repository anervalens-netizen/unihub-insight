...
- [ ] Read-model-uri Retail sunt publicate aditiv; Sales Calendar folosește view-ul zilnic reconciliat, Visits v2 păstrează autorul Team Leader, Planning v2 cere head CAS, migrarea 057 adaugă Campaigns v3 și Concurs v1, iar 058 adaugă Grile v2 și snapshot v6 fără a rupe N-1. Campaigns/Concurs rămân corect `partial` când sales este legacy/partial; Finance/Compensation și forecastul Planning nu au încă head/generație eligibilă.
