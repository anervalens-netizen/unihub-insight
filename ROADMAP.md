...
- [ ] Read-model-uri Retail sunt publicate aditiv; Sales Calendar folosește view-ul zilnic reconciliat, Visits folosește contractul v2 oficial pe autor Team Leader, iar Planning v2 publică numai forecasturi cu head CAS și Targeturi cu snapshot exact. Workforce/Campaigns rămân `partial`; Finance/Compensation și Planning live nu au încă head/generație eligibilă.
...
- [ ] Reconcilierea live verifică inclusiv Visits v2 ↔ felia Performance la grain-ul oficial; matricea completă trece 30/30 pe 2026-07 și 2026-08, cu diferențe zero. Load/concurrency, backup-ul off-host restaurat izolat și rollback N→N-1→N trec pe candidatul publicat; matricea reală a celor trei sesiuni Authentik și RUM pe 7 zile rămân deschise.
...
- Matricea live de reconciliere trece 30/30 scope-uri reprezentative pe luna închisă 2026-07 și luna curentă 2026-08: Sales/Target/Visits/Campaigns/Workforce au diferențe zero, iar Compensation/Finance/Planning rămân explicit indisponibile unde nu există o generație eligibilă.
